 ...
 */
#ifndef LATTICE
#define CONFIG_FILE_DIR "/u/suvangi/etc"
#else
 ...
 */
#define DEFAULT_PRAGMAS PRAGMA_WARNINGS + PRAGMA_STRICT_TYPES + PRAGMA_SAVE_TYPES + PRAGMA_ERROR_CONTEXT
...
/* PACKAGE_NEWMOON: define this to enable the Aurora/Discworld/New Moon
 *   efuns, namely actions_defined() and event().
 *   This also enables priorities and stars in add_action()ed words.
 */
#define PACKAGE_NEWMOON
...
#define CFG_MAX_LOCAL_VARIABLES 		30
